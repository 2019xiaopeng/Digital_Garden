...
import { Home, Clock, BookOpen, FolderOpen, CalendarDays, Github, Moon, Sun, Settings, Target, BarChart3, NotebookPen } from "lucide-react";
...
const navItems = [
  ...
  { name: "错题本", path: "/error-book", icon: NotebookPen },
